...
/*
 * MMCEMAN can access MMCE devices in both memory-card slots. Do not hard-filter
 * one SIO2 port here, or normal MCMAN access to that slot becomes a no-op after
 * MMCEMAN is loaded. SIO2 transfers are serialized by sio2man_hook_sio2_lock().
 */
/* #define PORT_NR 3 */
#ifndef M_DEBUG
